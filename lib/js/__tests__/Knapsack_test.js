...
describe("Knapsack", (function () {
        ...
        var totalSize = List.fold_left((function (acc, i) {
        ...
        describe("finding the best", (function () {
                return Jest.test("gets the right index for one element", (function () {
                              ...
                              var res = Knapsack.BasicKnapsack[/* findBest */2](sack, items);
                              if (res) {
                                return Jest.Expect[/* toEqual */12](0)(Jest.Expect[/* expect */0](res[0]));
                              } else {
        ...
        describe("appending", (function () {
                ...
                Jest.test("can append", (function () {
                        ...
                        var res = Knapsack.BasicKnapsack[/* append */1](sack, item);
                        var exit = 0;
                        if (res) {
                ...
                return Jest.test("can't append", (function () {
                              var res = Knapsack.BasicKnapsack[/* append */1](sack, /* record */[
                                    /* weight */4,
                                    /* value */1
                                  ]);
                              if (res) {
                                return Jest.Expect[/* toEqual */12](0)(Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0](0)));
                              } else {
                                return Jest.Expect[/* toEqual */12](0)(Jest.Expect[/* expect */0](0));
                              }
                            }));
              }));
        Jest.test("filled knapsack", (function () {
                var sack = Knapsack.BasicKnapsack[/* make */0](totalSize);
                var res = Knapsack.BasicKnapsack[/* pack */3](sack, items);
                if (res[1]) {
        ...
        return Jest.test("unfilled knapsack", (function () {
                      ...
                      if (res[1]) {
                        ...
                        return Jest.Expect[/* toEqual */12](List.length(items))(Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0](List.length(res[0][/* items */1]))));
                      }
                    }));
      }));
