...
describe("Knapsack", (function () {
        ...
        Jest.test("unfilled knapsack", (function () {
        ...
        describe("monadic and functor operations", (function () {
                describe("functor", (function () {
                        Jest.test("will transform items if they fit", (function () {
                                ...
                                var newSack = Knapsack.BasicKnapsack[/* map */1]((function (items) {
                                        return /* :: */[
                                                /* record */[
                                                  /* weight */5,
                                                  /* value */1
                ...
                describe("bind", (function () {
                        Jest.test("binds sacks if they fit", (function () {
                                var addItem = function (i) {
                                  var partial_arg = Knapsack.BasicKnapsack[/* map */1];
                                ...
                                var sack = Knapsack.BasicKnapsack[/* make */0](5);
                                var newSack = Knapsack.BasicKnapsack[/* >>= */3](Knapsack.BasicKnapsack[/* >>= */3](sack, addItem(/* record */[
                                              /* weight */2,
                                              /* value */1
                                            ])), addItem(/* record */[
                                          /* weight */3,
